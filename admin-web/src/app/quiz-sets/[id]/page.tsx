...
export default function EditQuizSetPage() {
  ...
  const updateMut = useMutation({
    mutationFn: (data: Parameters<typeof updateQuizSet>[1]) =>
  ...
  const toggleMut = useMutation({
    ...
    onSuccess: () => qc.invalidateQueries({ queryKey: ["quiz-sets"] }),
  });
  ...
  return (
    <div className="max-w-3xl">
      <div className="flex items-center gap-3 mb-6">
        <Link href="/quiz-sets" className="p-1.5 rounded hover:bg-gray-100">
